...
typedef NS_ENUM(NSInteger, LABiometryType)
{
    ...
    LABiometryNone API_DEPRECATED_WITH_REPLACEMENT("LABiometryTypeNone", macos(10.13, 10.13.2), ios(11.0.1, 11.2)) = LABiometryTypeNone,
...
} API_AVAILABLE(macos(10.13.2), ios(11.0.1)) API_UNAVAILABLE(watchos, tvos);
...
@property (nonatomic, readonly) LABiometryType biometryType API_AVAILABLE(macos(10.13.2), ios(11.0.1)) API_UNAVAILABLE(watchos, tvos);
