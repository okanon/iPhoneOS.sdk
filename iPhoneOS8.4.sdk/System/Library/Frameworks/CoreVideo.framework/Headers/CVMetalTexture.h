...
CV_EXPORT CFTypeID CVMetalTextureGetTypeID(void) __OSX_AVAILABLE_STARTING(__MAC_NA,__IPHONE_8_0);
...
*/
CV_EXPORT id <MTLTexture> CVMetalTextureGetTexture( CVMetalTextureRef image) __OSX_AVAILABLE_STARTING(__MAC_NA,__IPHONE_8_0);
...
*/
CV_EXPORT Boolean CVMetalTextureIsFlipped( CVMetalTextureRef image) __OSX_AVAILABLE_STARTING(__MAC_NA,__IPHONE_8_0);
...
*/
CV_EXPORT void CVMetalTextureGetCleanTexCoords( CVMetalTextureRef image, 
                                                   float lowerLeft[2],
                                                   float lowerRight[2],
                                                   float upperRight[2],
                                                   float upperLeft[2]) __OSX_AVAILABLE_STARTING(__MAC_NA,__IPHONE_8_0);
