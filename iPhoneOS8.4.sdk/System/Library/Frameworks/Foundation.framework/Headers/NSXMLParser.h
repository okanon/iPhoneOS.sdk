...
@property NSXMLParserExternalEntityResolvingPolicy externalEntityResolvingPolicy NS_AVAILABLE(10_10, 8_0); //defaults to NSXMLNodeLoadExternalEntitiesNever

@property (copy) NSSet *allowedExternalEntityURLs NS_AVAILABLE(10_10, 8_0);
